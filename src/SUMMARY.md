...
- [Основной концепт SCP](ru/_stories/scp/base-conception.md)
- [TODO list для запуска](ru/_stories/scp/todo-list.md)
- [Режимы игры]()
...
- [Установка](ru/general-development/setup.md)
  ...
  - [Git для SS14 Разработчика](ru/general-development/setup/git-for-the-ss14-developer.md)
...
- [Player Interaction](ru/space-station-14/player-interaction.md)
	...
	- [Proposals]()
	  - [PAI Expansion Slots](ru/space-station-14/player-interaction/proposals/pai-expansion-slots.md)
...
- [Infrastructure References](ru/community/infrastructure-references.md)
  ...
  - [Publishing Scripts](ru/community/infrastructure-reference/publishing-scripts.md)
...
- [Space Wizards Role Hierarchy](ru/community/space-wizards-role-hierarchy.md)
- [Space Wizards Maintainer List](ru/community/space-wizards-maintainer-list.md)
- [Discord Rich Presence Repository](ru/community/discord-rich-presence-repository.md)
- [Project Manager](ru/community/projectmanager.md)
- [Maintainer](ru/community/maintainer.md)
  - [Review Policy](ru/community/maintainer/wizards-den-review-policy.md)
...
- [Maintainer Policy](ru/staff/maintainer-policy.md)
- [Staff Conflict Resolution](ru/staff/staff-conflict-resolution.md)
...
- [2023-06-10](ru/maintainer-meetings/maintainer-meeting-2023-06-10.md)
